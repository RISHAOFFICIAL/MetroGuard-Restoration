# Brand Strategy: MetroGuard Restoration

## 1. Brand Name Options & Domains

| Brand Name | Vibe | Potential Domain |
| :--- | :--- | :--- |
| **MetroGuard Restoration** | Authoritative, Protective, Established | `metroguardmi.com` |
| **Lakeside Premier Restoration** | High-end, Trustworthy, Regional | `lakesidepremier.com` |
| **Motor City Flood Shield** | Rugged, Local Pride, Reliable | `motorcityshield.com` |

**Recommendation:** **MetroGuard Restoration**
*Rationale:* It strikes the perfect balance between "Premium" and "Fast Emergency Response." The name implies a high level of protection and local coverage ("Metro").

---

## 2. Logo Direction
*   **Iconography:** A stylized **Shield** encompassing a **Water Drop**. The shield should have clean, sharp edges to imply modern technology. A subtle "M" or the Detroit skyline could be integrated into the shield's base.
*   **Color Palette:**
    *   **Navy Blue (#1B365D):** Professionalism, trust, and the element of water.
    *   **Steel Silver (#A2AAAD):** Cleanliness, premium equipment, and modernity.
    *   **Action Orange (#FF5F00):** Used sparingly for "24/7" or "Emergency" call-to-action buttons.
*   **Typography:** Bold, uppercase Sans-Serif (e.g., *Montserrat Bold* or *Roboto Black*). The font should feel heavy and stable.
